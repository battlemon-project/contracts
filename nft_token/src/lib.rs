...
use token_metadata_ext::{TokenExt, TokenMetadataExt, TokenProperties};
...
pub struct Contract {
    ...
    token_properties_by_id: LookupMap<TokenId, TokenProperties>,
}
...
impl Contract {
    ...
    fn new(owner_id: AccountId, metadata: NFTContractMetadata) -> Self {
        ...
        let token_properties_by_id = LookupMap::new(StorageKey::TokenProperties);

        Self {
            tokens,
            metadata,
            token_properties_by_id,
        }
    }
